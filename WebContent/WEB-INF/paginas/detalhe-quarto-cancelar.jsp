...
<div id="main" class="container-fluid">
	<h3 class="page-header">Detalhe do Quarto</h3>
	<div class="row">
		<div class="col-md-offset-1 col-md-10 col-md-offset-1">
			<form action="sistema?logica=EditarQuartoCancelar&codigo=${quarto.codigo}"
				method="POST">
				...
				<div class="form-group">
					<label for="tipo">Tipo</label> 
								<select
									class="form-control" name="tipo" id="tipo" value="${quarto.tipo}" disabled>
									<option>Casal</option>
